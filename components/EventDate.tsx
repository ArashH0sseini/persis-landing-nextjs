        ...
        <div className='flex flex-col md:flex-row items-center justify-between w-[90%] lg:w-[80%] space-y-10 md:space-y-0 m-auto'>
            <div className='flex justify-between items-center space-x-4 space-x-reverse ring-2 ring-[#FF821E] md:ring-0 md:p-0 p-6 rounded-2xl w-72 md:w-auto'>
                ...
                <div className='flex flex-col md:w-full space-y-2'>
                    ...
                    <div className='space-y-1'>
                        <p className='text-white text-sm md:text-base'>پنل نقش هیئت مدیره</p>
                        <p className='text-white text-sm md:text-base'>در مقاطع حساس کسب و کار</p>
                    </div>                
                </div>
            </div>
            ...
            <div className='flex justify-between items-center space-x-4 space-x-reverse ring-2 ring-[#FF821E] md:ring-0 md:p-0 p-6 rounded-2xl w-72 md:w-auto'>
                ...
                <div className='flex flex-col space-y-2'>
                    ...
                    <div className='space-y-1'>
                        <p className='text-white text-sm md:text-base'>کارگاه مفاهیم مالی</p>
                        <p className='text-white text-sm md:text-base'>کارگاه مبانی حاکمیت شرکتی</p>
                    </div>
                </div>
            </div>
            ...
            <div className='flex justify-between items-center space-x-4 space-x-reverse ring-2 ring-[#FF821E] md:ring-0 md:p-0 p-6 rounded-2xl w-72 md:w-auto'>
                ...
                <div className='flex flex-col space-y-2'>
                    ...
                    <div className='space-y-1'>
                        <p className='text-white text-sm md:text-base'>کارگاه مدیریت ارتباطات</p>
                        <p className='text-white text-sm md:text-base'>کارگاه مدیریت ریسک</p>
                    </div>                
                </div>
            </div>
        </div>
