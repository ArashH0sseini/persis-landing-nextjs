      ...
      <div className="w-full lg:w-[50%] mt-16">
        <div className="flex flex-col">
          <img
            src={quote.src}
            alt=""
            className="w-14 lg:w-20 rotate-180 mr-10"
          />
          <p className="text-justify text-base lg:text-lg leading-10 px-10 border-r-2 border-l-2 border-[#FF821E]">
          ...
          <div className="flex justify-end ml-10">
            <img src={quote.src} alt="" className="w-14 lg:w-20" />
          </div>
        </div>
      </div>
    </div>
